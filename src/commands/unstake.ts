...
import { runPrecheck, measureTxBytes, checkUnstake } from '../lib/precheck.js';
  ...
  program
    ...
    .action(async (cmdOpts, cmd) => {
      ...
      try {
        ...
        await runPrecheck('Checking staked amount...', () =>
          checkUnstake(tronWeb, address, resource, amountSun, measureTxBytes(tx)));
